...
(**question 2*)
let q24_1 = Vrai;; (* Vrai *)
let q24_2_1= And(Vrai,Faux);; (* Vrai et faux *)
let q24_2_2=Neg(Vrai);; (* non vrai *)
let q24_2_3=Or(Vrai,Faux);; (* vrai ou faux *)
let q24_2_4=Implique(Faux,Or(Vrai,Faux));; (* faux implique vrai ou faux *)
